...
<body>
	...
	<form method="POST">
		<div class="mb-3">	
			<lable class="form-label">강의 아이디: </lable>
			<input class="form-control" type="text" name="courseid">
		</div>
		
		<div class="mb-3">	
			<lable class="form-label" >강좌 이름: </lable>
			<input class="form-control" type="text" name="coursename">
		</div>
		
		<div class="mb-3">	
			<lable class="form-label">강의 교수: </lable>
			<input class="form-control" type="text" name="professor">
		</div>
		
		<div class="mb-3">	
			<lable class="form-label">강의 가격 : </lable>
			<input class="form-control"  type="text" name="courseprice">
		</div>
